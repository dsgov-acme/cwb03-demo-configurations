...
import io.nuvalence.config.notification.client.generated.models.PagingMetadata;
 ...
 */
@JsonPropertyOrder({
  EmailLayoutPageDTO.JSON_PROPERTY_ITEMS,
  EmailLayoutPageDTO.JSON_PROPERTY_PAGING_METADATA
})
...
public class EmailLayoutPageDTO {
  public static final String JSON_PROPERTY_ITEMS = "items";
  private List<EmailLayoutResponseModel> items = new ArrayList<>();

  public static final String JSON_PROPERTY_PAGING_METADATA = "pagingMetadata";
  private PagingMetadata pagingMetadata;

  public EmailLayoutPageDTO() { 
  }

  public EmailLayoutPageDTO items(List<EmailLayoutResponseModel> items) {
    this.items = items;
    return this;
  }

  public EmailLayoutPageDTO addItemsItem(EmailLayoutResponseModel itemsItem) {
  ...
  **/
  ...
  public List<EmailLayoutResponseModel> getItems() {
    return items;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(List<EmailLayoutResponseModel> items) {
    this.items = items;
  }


  public EmailLayoutPageDTO pagingMetadata(PagingMetadata pagingMetadata) {
  ...
  **/
  ...
  /**
   * Return true if this EmailLayoutPageDTO object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EmailLayoutPageDTO emailLayoutPageDTO = (EmailLayoutPageDTO) o;
    return Objects.equals(this.items, emailLayoutPageDTO.items) &&
        Objects.equals(this.pagingMetadata, emailLayoutPageDTO.pagingMetadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailLayoutPageDTO {\n");
